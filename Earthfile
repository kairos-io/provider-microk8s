...
ARG BASE_IMAGE=quay.io/kairos/core-ubuntu-20-lts:v1.2.1
...
cosign:
    ...
    RUN cosign sign $IMAGE_REPOSITORY/${BASE_IMAGE_NAME}-microk8s:v${MICROK8S_VERSION_TAG}
    RUN cosign sign $IMAGE_REPOSITORY/${BASE_IMAGE_NAME}-microk8s:v${MICROK8S_VERSION_TAG}_${VERSION}
